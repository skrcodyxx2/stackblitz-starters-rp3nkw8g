/*
  # Fix profile fetch timeout issues

  1. Improvements
    - Add indexes to improve query performance
    - Simplify RLS policies to reduce query complexity
    - Fix potential recursion issues in admin policies
    - Ensure public access to necessary tables

  2. Security
    - Maintain proper row-level security
    - Use JWT metadata for role checks to avoid recursion
